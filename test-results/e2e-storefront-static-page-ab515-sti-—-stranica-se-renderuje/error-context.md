...
- Name: e2e/storefront/static-pages.spec.ts >> Storefront: Statičke stranice >> /politika-privatnosti — stranica se renderuje
...
Call log:
  - navigating to "/politika-privatnosti", waiting until "load"
