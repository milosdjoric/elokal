...
- Name: e2e/storefront/auth.spec.ts >> Storefront: Autentifikacija >> post-login redirect — vraća korisnika gde je bio
- Location: e2e/storefront/auth.spec.ts:68:7
...
Call log:
  - navigating to "/account/wishlist", waiting until "load"
