...
- Name: e2e/storefront/search.spec.ts >> Storefront: Pretraga >> /pretraga — search stranica renderuje rezultate
- Location: e2e/storefront/search.spec.ts:17:7
...
Call log:
  - navigating to "/search?q=test", waiting until "load"
