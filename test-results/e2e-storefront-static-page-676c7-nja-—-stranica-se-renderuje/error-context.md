...
- Name: e2e/storefront/static-pages.spec.ts >> Storefront: Statičke stranice >> /uslovi-koriscenja — stranica se renderuje
...
Call log:
  - navigating to "/uslovi-koriscenja", waiting until "load"
