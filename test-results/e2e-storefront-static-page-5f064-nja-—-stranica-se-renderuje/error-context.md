...
- Name: e2e/storefront/static-pages.spec.ts >> Storefront: Statičke stranice >> /cesta-pitanja — stranica se renderuje
...
Call log:
  - navigating to "/cesta-pitanja", waiting until "load"
