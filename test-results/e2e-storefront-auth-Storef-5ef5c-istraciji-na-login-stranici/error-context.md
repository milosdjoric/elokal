...
- Name: e2e/storefront/auth.spec.ts >> Storefront: Autentifikacija >> navigacija — link ka registraciji na login stranici
- Location: e2e/storefront/auth.spec.ts:80:7
