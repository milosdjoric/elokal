...
- Name: e2e/storefront/auth.spec.ts >> Storefront: Autentifikacija >> auth guard — zaštićena stranica redirectuje na login
- Location: e2e/storefront/auth.spec.ts:63:7
...
Call log:
  - navigating to "/account/orders", waiting until "load"
