  ...
  <footer class="bg-dark text-white mt-16">
    <div class="max-w-7xl mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <!-- Info -->
        <div>
          <h4 class="text-sm font-semibold uppercase tracking-wider mb-4">Informacije</h4>
          <ul class="space-y-2 text-sm text-gray-300">
            <li><a href="#" class="hover:text-white">O nama</a></li>
            <li><a href="#" class="hover:text-white">Dostava</a></li>
            <li><a href="#" class="hover:text-white">Povrat robe</a></li>
