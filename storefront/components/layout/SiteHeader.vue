    ...
    <div class="max-w-7xl mx-auto px-4">
      ...
      <div class="flex items-center justify-between h-16 gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <!-- Wishlist -->
          <NuxtLink to="/nalog/wishlist" class="relative p-2 text-gray-600 hover:text-red-500">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <div v-if="mobileMenuOpen" class="fixed inset-0 z-50">
        ...
        <div class="absolute left-0 top-0 bottom-0 w-80 max-w-[85vw] bg-white shadow-xl flex flex-col overflow-y-auto">
          ...
          <div class="border-t px-4 py-4 space-y-2">
            ...
            <NuxtLink to="/nalog/wishlist" class="block text-sm text-gray-600 hover:text-primary-600" @click="mobileMenuOpen = false">
              Lista želja
            </NuxtLink>
