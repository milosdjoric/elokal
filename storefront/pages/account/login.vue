...
<template>
  <div class="max-w-md mx-auto px-4 py-12">
    ...
    <div class="mt-6 text-center text-sm text-gray-500 space-y-2">
      <p>
        <NuxtLink to="/account/forgot-password" class="text-primary-600 hover:underline">Zaboravili ste lozinku?</NuxtLink>
      </p>
      <p>
        Nemate nalog?
        <NuxtLink to="/account/register" class="text-primary-600 font-medium hover:underline">Registrujte se</NuxtLink>
      </p>
    </div>
  </div>
</template>
