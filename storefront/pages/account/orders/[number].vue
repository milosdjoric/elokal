...
<template>
  <div class="max-w-5xl mx-auto px-4 py-8">
    <LayoutBreadcrumbs :items="[
      { label: 'Moj nalog', to: '/account' },
      { label: 'Narudžbine', to: '/account/orders' },
      { label: orderNumber },
    ]" />
        ...
        <template v-else-if="order">
          ...
          <div class="mb-6">
            ...
            <div class="border border-gray-200 divide-y divide-gray-200">
              ...
              >
                <!-- Slika -->
                <NuxtLink v-if="item.product_slug" :to="`/products/${item.product_slug}`" class="flex-shrink-0">
                  <img
                ...
                <div class="flex-1 min-w-0">
                  <NuxtLink v-if="item.product_slug" :to="`/products/${item.product_slug}`" class="font-medium text-gray-800 hover:text-primary-600 truncate block">
                    {{ item.product_name }}
                  </NuxtLink>
