  ...
  <section v-if="products.length" class="relative">
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="flex gap-2">
        <button class="w-8 h-8 border border-gray-300 flex items-center justify-center hover:bg-gray-50" aria-label="Prethodno" @click="scrollLeft">
          <Icon name="lucide:chevron-left" class="w-4 h-4" />
        </button>
        <button class="w-8 h-8 border border-gray-300 flex items-center justify-center hover:bg-gray-50" aria-label="Sledeće" @click="scrollRight">
