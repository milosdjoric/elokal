...
useHead({ title: computed(() => category.value ? `${category.value.name} — Blog — sloj kolektiv` : 'Blog — sloj kolektiv') })
</script>
...
<template>
  <div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <UiMoleculesEmptyState
      ...
      description="Pogledajte druge kategorije ili svežije objave na blogu."
    >
      <NuxtLink to="/blog">
