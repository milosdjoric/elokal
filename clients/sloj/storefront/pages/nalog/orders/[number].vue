...
useHead({ title: `Narudžbina ${orderNumber} — sloj kolektiv` })
              ...
              >
                ...
                <div class="relative flex items-center justify-center w-full">
                  ...
                  <div
                    ...
                    "
                  >
                    <Icon v-if="index < activeStepIndex" name="lucide:check" class="w-4 h-4" :stroke-width="3" />
              ...
              >
                ...
                <NuxtLink v-if="item.product_slug" :to="`/proizvodi/${item.product_slug}`" class="flex-shrink-0">
                  ...
                  <div v-else class="w-16 h-16 bg-gray-100 rounded flex items-center justify-center">
                    <Icon name="lucide:image" class="w-6 h-6 text-gray-300" :stroke-width="1.5" />
                  </div>
                </NuxtLink>
