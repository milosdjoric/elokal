...
useHead({ title: 'Krediti — sloj kolektiv' })
...
<template>
  <div class="max-w-5xl mx-auto px-4 py-8">
    <LayoutBreadcrumbs :items="[{ label: 'Moj nalog', to: '/nalog' }, { label: 'Krediti' }]" />
    ...
    <div class="flex flex-col lg:flex-row gap-8">
      ...
      <div class="flex-1">
        ...
        <UiMoleculesEmptyState
          ...
          variant="credits"
          size="md"
          title="Nemate store kredite"
          description="Krediti se dobijaju kao refund ili gift kartica — biće prikazani ovde."
        />
      </div>
    </div>
  </div>
