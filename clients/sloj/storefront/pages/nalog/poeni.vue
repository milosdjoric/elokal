...
useHead({ title: 'Poeni — sloj kolektiv' })
...
<template>
  <div class="max-w-5xl mx-auto px-4 py-8">
    <LayoutBreadcrumbs :items="[{ label: 'Moj nalog', to: '/nalog' }, { label: 'Poeni' }]" />
    ...
    <div class="flex flex-col lg:flex-row gap-8">
      ...
      <div class="flex-1">
        ...
        <UiMoleculesEmptyState
          ...
          variant="loyalty"
          size="md"
          title="Loyalty program nije aktiviran"
          description="Sakupljajte poene kupovinom — kontaktirajte podršku za aktivaciju ili pratite najavu."
        />
      </div>
    </div>
  </div>
